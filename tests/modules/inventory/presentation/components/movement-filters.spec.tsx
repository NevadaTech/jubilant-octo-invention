...
describe("MovementFilters", () => {
  ...
  it("Given: default filters When: rendering Then: should render search input", () => {
    render(<MovementFilters filters={defaultFilters} onFiltersChange={mockOnChange} />);
  ...
  it("Given: filters with types When: rendering Then: should show clear button", () => {
    render(<MovementFilters filters={{ ...defaultFilters, types: ["IN"] }} onFiltersChange={mockOnChange} />);
  ...
  it("Given: active filters When: clicking clear Then: should reset all filters", () => {
    render(<MovementFilters filters={{ ...defaultFilters, types: ["IN"], search: "test" }} onFiltersChange={mockOnChange} />);
