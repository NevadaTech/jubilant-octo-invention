...
describe("WarehouseFiltersComponent", () => {
  ...
  it("Given: default filters When: rendering Then: should render search input", () => {
    render(<WarehouseFiltersComponent filters={defaultFilters} onFiltersChange={mockOnChange} />);
  ...
  it("Given: filters with statuses When: rendering Then: should show clear button", () => {
    render(<WarehouseFiltersComponent filters={{ ...defaultFilters, statuses: ["ACTIVE"] }} onFiltersChange={mockOnChange} />);
  ...
  it("Given: active filters When: clicking clear Then: should reset", () => {
    render(<WarehouseFiltersComponent filters={{ ...defaultFilters, search: "main", statuses: ["ACTIVE"] }} onFiltersChange={mockOnChange} />);
    fireEvent.click(screen.getByText("clearFilters"));
    expect(mockOnChange).toHaveBeenCalledWith({ search: undefined, statuses: undefined, page: 1 });
  });
});
