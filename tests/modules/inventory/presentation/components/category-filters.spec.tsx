...
describe("CategoryFiltersComponent", () => {
  ...
  it("Given: default filters When: rendering Then: should render search input", () => {
    render(<CategoryFiltersComponent filters={defaultFilters} onFiltersChange={mockOnChange} />);
  ...
  it("Given: filters with search When: rendering Then: should show clear button", () => {
    render(<CategoryFiltersComponent filters={{ ...defaultFilters, search: "test" }} onFiltersChange={mockOnChange} />);
  ...
  it("Given: active filters When: clicking clear Then: should call onFiltersChange with cleared values", () => {
    render(<CategoryFiltersComponent filters={{ ...defaultFilters, search: "test", statuses: ["ACTIVE"] }} onFiltersChange={mockOnChange} />);
