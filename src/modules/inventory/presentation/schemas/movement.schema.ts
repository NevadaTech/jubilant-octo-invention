...
export const createMovementSchema = z.object({
  ...
  lines: z.array(movementLineSchema).min(1, "At least one product is required"),
});
...
export type ManualMovementType = "IN" | "OUT" | "ADJUST_IN" | "ADJUST_OUT";
